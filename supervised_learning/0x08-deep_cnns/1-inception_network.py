...
def inception_network():
    ...
    Z = K.layers.Conv2D(64, (7, 7), strides=(2, 2),
                        padding='same', activation='relu')(X)

    Z = K.layers.MaxPool2D((3, 3),
                           strides=(2, 2), padding='same')(Z)
    Z = K.layers.Conv2D(64, (1, 1),
                        strides=(1, 1), padding='same',
                        activation='relu')(Z)
    Z = K.layers.Conv2D(192, (3, 3),
                        strides=(1, 1), padding='same',
                        activation='relu')(Z)
    Z = K.layers.MaxPool2D((3, 3),
                           strides=(2, 2), padding='same')(Z)
